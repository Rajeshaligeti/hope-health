...
import { Ca                     <span className="animate-typing">●</span>
                <span className="animate-typing animate-typing-delay-1">●</span>
                <span className="animate-typing animate-typing-delay-2">●</span>      <div className="flex items-center gap-1">
                <span className="animate-typing">●</span>
                <span className="animate-typing animate-typing-delay-1">●</span>
                <span className="animate-typing animate-typing-delay-2">●</span>
        ...
        <div className="p-4 space-y-4">
          {messages.map((message) => (
            ...
            >
              ...
              >
                <p className="text-sm leading-relaxed whitespace-pre-wrap break-words overflow-hidden">{message.message}</p>
